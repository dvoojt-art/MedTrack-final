...
export default function PublicPortalPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col animate-in fade-in duration-700">
      ...
      <header className="bg-white/90 backdrop-blur-md border-b px-6 py-4 flex items-center justify-between sticky top-0 z-10 shadow-sm animate-in slide-in-from-top duration-500">
        <div className="flex items-center gap-2">
          <div className="h-10 w-10 bg-accent rounded-xl flex items-center justify-center text-primary shadow-sm border border-accent/10 hover:rotate-12 transition-transform duration-300">
      ...
      <main className="max-w-4xl mx-auto p-6 md:p-10 w-full flex-1">
        ...
        `}
          ...
          >
            <DialogContent className="w-[95vw] max-w-5xl overflow-hidden rounded-3xl border bg-background p-0 data-[state=open]:animate-[dialogPop_0.35s_cubic-bezier(0.34,1.56,0.64,1)]">
              {/* Header */}

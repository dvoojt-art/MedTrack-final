        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl animate-in fade-in slide-in-from-bottom-8 duration-700">
          <Card className="group hover:shadow-2xl transition-all border-none overflow-hidden relative shadow-sm bg-slate-50">
            ...
            <CardContent className="p-10 flex flex-col items-center text-center space-y-5">
              <div className="h-20 w-20 bg-slate-500 rounded-2xl flex items-center justify-center text-primary group-hover:scale-110 transition-transform">
          ...
          <Card className="group hover:shadow-2xl transition-all border-none overflow-hidden relative shadow-sm bg-slate-50">
            ...
            <CardContent className="p-10 flex flex-col items-center text-center space-y-5">
              <div className="h-20 w-20 bg-primary rounded-2xl flex items-center justify-center text-slate-700 group-hover:scale-110 transition-transform">
              ...
              <Button asChild className="w-full bg-primary hover:bg-primary/90 text-slate-700 font-bold h-12 mt-4 gap-2">
                <Link href="/login">

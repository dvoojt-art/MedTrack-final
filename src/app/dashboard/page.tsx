      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        <Card className="border-none shadow-sm">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Lifetime records captured</p>
          </CardContent>
        </Card>
        <Card className="border-none shadow-sm">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Entries made in the last 24h</p>
          </CardContent>
        </Card>
        <Card className="border-none shadow-sm">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Individual units issued</p>
          </CardContent>
        </Card>
        <Card className="border-none shadow-sm">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-7">
        <Card className="lg:col-span-4 border-none shadow-sm">
          <CardHeader>
            ...
            <CardDescription>Latest medicine issuance logs from the portal.</CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="p-4 border-l-4 border-amber-400 bg-amber-50/50 rounded-r-lg">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xs font-bold text-amber-700">Security Note</span>
              </div>
              <p className="text-[10px] text-amber-800/80">
                Regularly audit administrator access in the User Management section to maintain system integrity.
              </p>
            </div>
          </CardContent>
        </Card>
